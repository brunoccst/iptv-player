...
const paths = {
  ...
  rewind10: 'M12 5V1L7 6l5 5V7a6 6 0 1 1-6 6H4a8 8 0 1 0 8-8zm-1.1 11H10v-3.3L9 13v-.7l1.8-.6h.1zm4.3-1.8c0 .3 0 .6-.1.8l-.3.6-.4.3c-.2.1-.4.1-.6.1s-.4 0-.6-.1l-.4-.3-.3-.6-.1-.8v-.7c0-.3 0-.6.1-.8l.3-.6.4-.3c.2-.1.4-.1.6-.1s.4 0 .6.1l.4.3.3.6.1.8zm-.9-.8v-.5l-.1-.4-.2-.2h-.5l-.2.2-.1.4v1.5l.1.4.2.2h.5l.2-.2.1-.4z',
  forward10: 'M4 13a8 8 0 1 0 8-8V1l5 5-5 5V7a6 6 0 1 1-6 6zm6.9 3H10v-3.3L9 13v-.7l1.8-.6h.1zm4.3-1.8c0 .3 0 .6-.1.8l-.3.6-.4.3c-.2.1-.4.1-.6.1s-.4 0-.6-.1l-.4-.3-.3-.6-.1-.8v-.7c0-.3 0-.6.1-.8l.3-.6.4-.3c.2-.1.4-.1.6-.1s.4 0 .6.1l.4.3.3.6.1.8zm-.9-.8v-.5l-.1-.4-.2-.2h-.5l-.2.2-.1.4v1.5l.1.4.2.2h.5l.2-.2.1-.4z',
  ...
  subtitles: 'M20 4H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM4 12h4v2H4zm10 6H4v-2h10zm6 0h-4v-2h4zm0-4H10v-2h10z',
  ...
  offline: 'M23.6 7A16.3 16.3 0 0 0 12 3c-1.3 0-2.5.2-3.7.4l10.5 10.5zM3.5 1.5 2 2.9l2.1 2.1A17 17 0 0 0 .4 7L12 21.5l3.9-4.9 3.3 3.3 1.4-1.4z',
  logout: 'M10.1 15.6 11.5 17l5-5-5-5-1.4 1.4 2.6 2.6H3v2h9.7zM19 3H5a2 2 0 0 0-2 2v4h2V5h14v14H5v-4H3v4c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z',
} as const;
