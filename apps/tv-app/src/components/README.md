...
| `SideRail.tsx` | Left navigation (☰ toggle, profile, Home, Series, Movies, Live TV, Downloads) in a `TVFocusGuideView`. ☰ collapses it to a 56 dp strip; the choice is saved in `fileStorage`. |
