...
| `AccountMenu.tsx` | Menu under the avatar: other profiles, Manage Profiles, Parental PIN, Back up data, Playback (when FFmpeg is bundled), Refresh library, Log, Sign out. `confirmSignOut` asks first. |
