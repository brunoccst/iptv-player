...
export const iconPaths = {
  ...
  forward10:
    'M12 5V1l5 5-5 5V7a6 6 0 1 0 6 6h2a8 8 0 1 1-8-8zm-1.1 11H10v-3.3L9 13v-.7l1.8-.6h.1zm4.3-1.8c0 .3 0 .6-.1.8l-.3.6-.4.3c-.2.1-.4.1-.6.1s-.4 0-.6-.1l-.4-.3-.3-.6-.1-.8v-.7c0-.3 0-.6.1-.8l.3-.6.4-.3c.2-.1.4-.1.6-.1s.4 0 .6.1l.4.3.3.6.1.8zm-.9-.8v-.5l-.1-.4-.2-.2h-.5l-.2.2-.1.4v1.5l.1.4.2.2h.5l.2-.2.1-.4z',
  ...
  phone: 'M17 1H7a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2zm0 18H7V5h10z',
