...
| `xtream.ts` | `normalizeServerUrl`, `createXtreamClient` (validate, categories, live channels, movies, series, details, short EPG, direct playback URLs). Same DTOs as the backend, including the TMDB id some panels send in their lists (D-065). |
